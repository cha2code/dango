		...
		return {
			...
			token : function (stream, state) {
				...
				if (stream.match(/#.*/)) {
					...
					// FEATURE
				} else if (!state.inKeywordLine && state.allowFeature && stream.match(
					...
					// BACKGROUND
				} else if (!state.inKeywordLine && state.allowBackground && stream.match(
					...
					// SCENARIO OUTLINE
				} else if (!state.inKeywordLine && state.allowScenario && stream.match(
					...
					// STEPS
				} else if (!state.inKeywordLine && state.allowSteps && stream.match(
