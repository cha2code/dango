	...
	return /******/ (() => { // webpackBootstrap
		...
		(() => {
			...
			function TooltipUI_createClass(Constructor, protoProps, staticProps) {
				if (protoProps) {
					TooltipUI_defineProperties(Constructor.prototype,
					                           protoProps);
				}
				if (staticProps) {
			...
			var TooltipUI = /*#__PURE__*/function () {
				function TooltipUI($node, options) {
					...
					this.$tooltip = external_jQuery_default()(['<div class="note-tooltip">',
							                                                                                 ...
							                                                                                 toggle : 'dropdown'
						                                                                                              ...
						                                                                                              click : function click(event) {
							                                                                                              ...
							                                                                                              var value = $button.data(
									                                                                                              'value');
							                                                                                              var foreinput = document.getElementById(
									                                                                                              'html5fcp').value;
							                                                                                              var backinput = document.getElementById(
									                                                                                              'html5bcp').value;
			...
			var dialog = renderer.create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', function ($node, options) {
				...
				$node.html(['<div class="note-modal-content">',
				            options.title
				            ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' + options.title + '</h4></div>'
				            : '',
			...
			var popover = renderer.create(['<div class="note-popover bottom">',
