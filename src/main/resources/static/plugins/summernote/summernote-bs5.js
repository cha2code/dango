	...
	return /******/ (() => { // webpackBootstrap
		...
		(() => {
			...
			function summernote_bs5_typeof(obj) {
				"@babel/helpers - typeof";
				if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { summernote_bs5_typeof = function _typeof(obj) { return typeof obj; }; } else {
			...
			var dialog = renderer.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
			                             function ($node, options) {
				                             ...
				                             $node.html(['<div class="modal-dialog">',
				                                         ...
				                                         options.title
				                                         ? '<div class="modal-header">' + '<h4 class="modal-title">' + options.title + '</h4>' + '<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true"></button>' + '</div>'
				                                         : '',
			...
			var popover = renderer.create(['<div class="note-popover popover show">',
			...
			var ui = function ui(editorOptions) {
				return {
					...
					button : function button($node, options) {
						return renderer.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">',
						                       function ($node, options) {
