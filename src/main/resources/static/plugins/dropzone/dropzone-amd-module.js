				...
				addedfile : function addedfile(file) {
					...
					if (this.previewsContainer && !this.options.disablePreviews) {
						...
						if (this.options.addRemoveLinks) {
							file._removeLink = Dropzone.createElement("<a class=\"dz-remove\" href=\"javascript:undefined;\" data-dz-remove>".concat(
			...
			var Dropzone = /*#__PURE__*/function (_Emitter) {
				...
				dropzone_createClass(Dropzone, [{
							...
							return _this2.listeners.push({
								                             ...
								                             events : {
									                             click : function click(evt) {
										                             ...
										                             if (clickableElement !== _this2.element || evt.target === _this2.element || Dropzone.elementInside(
												                             evt.target,
					...
					value : function getFallbackForm() {
						...
						fieldsString += "<input type=\"file\" name=\"".concat(this._getParamName(0), "\" ").concat(this.options.uploadMultiple
						                                                                                           ? 'multiple="multiple"'
						                                                                                           : undefined,
						...
						if (this.element.tagName !== "FORM") {
							form = Dropzone.createElement("<form action=\"".concat(this.options.url, "\" enctype=\"multipart/form-data\" method=\"")
					...
					value : function accept(file, done) {
						if (this.options.maxFilesize && file.size > this.options.maxFilesize * 1024 * 1024) {
							done(this.options.dictFileTooBig.replace("{{filesize}}", Math.round(file.size / 1024 / 10.24) / 100).replace(
									"{{maxFilesize}}",
							...
							if (files[0].upload.chunked) {
								...
								var handleNextChunk = function handleNextChunk() {
									...
									var dataBlock = {
										...
										data : _transformedFile.webkitSlice ? _transformedFile.webkitSlice(start, end) : _transformedFile.slice(start,
										                                                                                                        end),
					...
					value : function _addFormElementData(formData) {
						...
						if (this.element.tagName === "FORM") {
							var _iterator15 = dropzone_createForOfIteratorHelper(this.element.querySelectorAll("input, textarea, select, button"),
							                                                     true),
									_step15;
				...
				dropzone_createClass(ExifRestore, null, [{
					...
					value : function encode64(input) {
						...
						while (true) {
							...
							output = output + this.KEY_STR.charAt(enc1) + this.KEY_STR.charAt(enc2) + this.KEY_STR.charAt(enc3) + this.KEY_STR.charAt(
									enc4);
							chr1 = chr2 = chr3 = "";
							enc1 = enc2 = enc3 = enc4 = "";
