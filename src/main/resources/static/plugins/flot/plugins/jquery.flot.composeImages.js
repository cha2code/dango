	...
	function getGenerateTempImg(tempImg, canvasOrSvgSource) {
		...
		return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
			...
			tempImg.onabort = function (evt) {
				...
				console.log('Can\'t generate temp image from ' + tempImg.sourceDescription + '. It is possible that it is missing some properties or its content is not supported by this browser. Source component:',
